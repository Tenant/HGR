...
%folder = fullfile('E:\Video');
% movieFullFileName = fullfile(folder, '平凡不简单！校阅女孩·河野悦子.Jiminisugoi.Kouetsu.Girl.Kouno.Etsuko.Ep01.Chi_Jap.HDTVrip.852X480-ZhuixinFan.mp4');
folder = fullfile('./');
